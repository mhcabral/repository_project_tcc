    ...
    <body>
        ...
        <form id="formTccAvaliador" name="formTccAvaliador" method="POST" action="<c:url value="/tccavaliador"/>"> 
            <p>
                ...
                <input type="hidden" name="tccLocais.estado" value="${tccLocais.estado}"/>   					// dúvida
            </p> 
            <p>
                <label for="nome">Avaliador*:</label>
            ...
            <p>
                ...
                <input id="tipo1" type="text" name="tipo1" value="${tccAvaliador.tipo}" size="30" disabled="true"/>  			 // dúvida
            </p>
        </form>
    </body>
</html>