        ...
        <div id="container">
            <div id="toolbar-box">
                <div class="m">
                                ...
                                <div class="icon">
                                    <ul>                                    
                                        <li class="button" id="toolbar-apply">
                                            <a href="${pageContext.request.contextPath}/tcclocais/create" id="new">
                    ...
                    <div class="pagetitle icon-48-article"><h2>Locais</h2></div>
                </div>
            </div>
            <br/>
            <p>
        ...
        <div id="demo">
            <form id="formTccLocais">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
                    ...
                    <tbody>
                        <c:forEach items="${tccLocaisList}" var="tccLocais">
                            <tr>
                                <td><input type="radio" name="RadioGroup1" value="${tccLocais.id}"/></td>
                                <td class="center">${tccLocais.nome}</td>
                                <td class="center">${tccLocais.descricao}</td>
                                <td class="center">${tccLocais.estado}</td>
                            </tr>
                        </c:forEach>                    
                    </tbody>
                    <tfoot>
