<%-- 
    Document   : analiseHistorico
    Created on : 12/04/2013, 19:24:58
...
<body>
                            ...
                            <ul>
                                ...
                                <c:if test="${empty historico}">
                                    <li class="button" id="toolbar-cancel">
                                        <a href="${pageContext.request.contextPath}/analise/historico" id="back">
    ...
    <c:if test="${not empty solicitacao.id}">
        ...
        <c:if test="${solicitacao.statusAtual == 'NOVA' || solicitacao.statusAtual == 'REENVIADA' || (solicitacao.statusAtual == 'PREAPROVADA' && sessionData.usuario.perfil == 1) || solicitacao.statusAtual == 'INDEFERIDA'}">
