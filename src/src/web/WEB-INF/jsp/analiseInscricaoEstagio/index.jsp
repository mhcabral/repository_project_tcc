    ...
    <script language="JavaScript" type="text/javascript">
        function radioHab(variavel) {
            ...
            if(Radio.checked){
                switch (variavel){
                    case 'show':
                        document.location.href="${pageContext.request.contextPath}/analise/estagios/"+Radio.value + "/show";                          
                        return;
                    }
                } else {
                    for(var i=0;i<Radio.length;i++) 
                    {
                        if(Radio[i].checked) 
                        {
                            switch (variavel){
                                case 'show':
                                    document.location.href="${pageContext.request.contextPath}/analise/estagios/"+Radio[i].value + "/show";
                                    return;
                                }
                            }
                        }
    ...
    <div id="container">
        <div id="toolbar-box">
            <div class="m">
                ...
                <div class="pagetitle icon-48-notice"><h2>Solicitações de Estágio</h2></div>
            </div>
        </div>
        <div>
                    ...
                    <tbody>
                        <c:forEach items="${estagioList}" var="estagio">
                            <tr>
                                ...
                                <td class="center"><a href="${pageContext.request.contextPath}/analise/estagios/${estagio.id}/show"><img src="${pageContext.request.contextPath}/img/show.png"></img></a></td>
                            </tr>
                        </c:forEach>                    
                    </tbody>
                    <tfoot>
