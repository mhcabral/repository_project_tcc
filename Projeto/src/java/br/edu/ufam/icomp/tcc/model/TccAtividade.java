...
@NamedQueries({
    ...
    @NamedQuery(name = "TccAtividade.findByAnexo", query = "SELECT t FROM TccAtividade t WHERE t.ordem in (1,3,5,8,12,15) AND t.periodo.id = :idPeriodo ORDER BY t.ordem"),
