...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
       ...
       options : {
         ...
         startParam : "start",
         endParam : "end",
         businessHours : {start: 7, end: 22, limitDisplay : false},
         newEventText : "Alocado",
         timeslotHeight: 20,
...
eventClick : function(calEvent, $event) {
      ...
      eventNew : function(calEvent, $event) {                    
        ...
        data : function(start, end, callback) {
         ...
         longMonths : ['Janeiro', 'Fevereiro', 'Mar&ccedil;o', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'],
