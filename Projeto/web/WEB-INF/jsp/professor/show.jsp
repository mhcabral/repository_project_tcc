...
<head>
    <title>Professor [Exibição]</title>
    <script>
        function remove(){
            decisao = confirm("Deseja realmente remover o professor?");
            if (decisao){
                document.location.href="${pageContext.request.contextPath}/professores/${professor.id}/remove";                                                              
            } else {
...
<body>
    <div id="toolbar-box">
        <div class="m">
                        ...
                        <div class="icon">
                            <ul>
                                <li class="button" id="toolbar-apply">
                                    <a href="${pageContext.request.contextPath}/professores/${professor.id}/edit" id="edit" class="toolbar">
                                ...
                                <li class="button" id="toolbar-cancel">
                                    <a href="${pageContext.request.contextPath}/professores" id="back">
            ...
            <div class="pagetitle icon-48-info"><h2>Informações do Professor</h2></div>
        </div>
    </div>
