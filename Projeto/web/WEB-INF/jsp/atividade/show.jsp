...
<head>
    ...
    <script>
        function remove(){
            ...
            if (decisao){
                document.location.href="${pageContext.request.contextPath}/atividades/${atividade.id}/remove";                                                              
            } else {
                        ...
                        <div class="icon">
                            <ul>
                                <li class="button" id="toolbar-apply">
                                    <a href="${pageContext.request.contextPath}/atividades/${atividade.id}/edit" id="edit" class="toolbar">
                                ...
                                <li class="button" id="toolbar-cancel">
                                    <a href="${pageContext.request.contextPath}/atividades" id="back">
