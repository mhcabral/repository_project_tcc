...
<head>
    <title>Análise Final de Monitoria</title>            
    ...
    <script language="JavaScript" type="text/javascript">
        function radioHab(variavel) {
            ...
            if(Radio.checked){
                switch (variavel){
                    case 'show':
                        document.location.href="${pageContext.request.contextPath}/analiseFinal/"+Radio.value + "/show";                          
                        return;
                    }
                } else {
                    for(var i=0;i<Radio.length;i++) 
                    {
                        ...
                        {                    
                            switch (variavel){
                                case 'show':
                                    document.location.href="${pageContext.request.contextPath}/analiseFinal/"+Radio[i].value + "/show";                          
                                    return;
                                }                    
                ...
                function adjustVagas() {
                    ...
                    var professorValue = $('#campo-professor').val();                                   
            
                    window.location = "${pageContext.request.contextPath}/analiseFinal/"+cursoValue+"/"+disciplinaValue+"/"+professorValue+"/search";
    ...
    <script language="JavaScript" type="text/javascript">
                function radioHab2(variavel) {
                    ...
                    if(Radio2.checked){
                        switch (variavel){
                            case 'show':
                                document.location.href="${pageContext.request.contextPath}/analiseFinal/"+Radio2.value + "/show";                          
                                return;
                            }
                        } else {
                            for(var i=0;i<Radio2.length;i++) 
                            {
                                ...
                                {                    
                                    switch (variavel){
                                        case 'show':
                                            document.location.href="${pageContext.request.contextPath}/analiseFinal/"+Radio2[i].value + "/show";                          
                                            return;
                                        }                    
                                    }                
                                }
    ...
    <div id="container">
        <div id="toolbar-box">
            <div class="m">
                                ...
                                <ul>
                                    <li class="button" id="toolbar-apply">
                                        <a href="javascript:radioHab('show')">
                                            <span width="32" height="32" border="0" class="icon-32-preview"></span>Analisar
                                        </a>
                                    </li>
                ...
                <div class="pagetitle icon-48-notice"><h2>Análise Final de Monitoria</h2></div>
            </div>
        </div>
        <div>
        ...
        <div id="demo"> 
            ...
            <div class="ui-widget">
                ...
                <label style="padding-left:80px" for="campo-professor">Professor:</label>
                <select id="campo-professor" name="campo-professor">
                    <option value="0"></option>
                    <c:forEach var="professor" items="${professorList}">
                        <option value="${professor.id}" <c:if test = "${professor.id == idProfessor}"> selected</c:if>>${professor}</option>
                    </c:forEach>
                </select>
                    ...
                    <thead>
                        ...
                        <c:forEach items="${inscricaoMonitoriaList}" var="inscricao">
                            <tr>
                                ...
                                <td class="center">${inscricao.inscrito.id}</td>
                                <td class="center">${inscricao.inscrito}</td>
                                ...
                                <td class="center"><a href="${pageContext.request.contextPath}/analiseFinal/${inscricao.id}/show"><img src="${pageContext.request.contextPath}/img/show.png"></img></a></td>
                            </tr>
                        </c:forEach>                    
                    </tbody>
                    <tfoot>
